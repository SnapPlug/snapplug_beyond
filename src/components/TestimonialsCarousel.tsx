    ...
    if (isAutoPlaying) {
      const animate = () => {
        setScrollPosition((prevPosition) => {
          ...
          const maxScroll = testimonialsData.length * 270; // 전체 카드 너비
    ...
    >
      ...
      <div 
        ...
        style={{ 
          ...
          width: `${testimonialsData.length * 270}px`
        }}
      >
        {testimonialsData.map((testimonial) => (
          ...
          >
            <div className="bg-[#121212]/80 border border-[#f0f0fa]/10 rounded-lg p-6 h-full flex flex-col">
              {/* 별점 */}
              ...
              <div className="flex items-center mt-auto">
                <div className={`w-12 h-12 ${testimonial.avatarColor} rounded-lg flex items-center justify-center mr-4`}>
                  <span className="text-black/60 font-bold text-lg">{testimonial.avatar}</span>
                </div>
                <div>
